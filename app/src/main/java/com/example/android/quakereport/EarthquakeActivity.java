...
public class EarthquakeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<ArrayList<EarthquakeDetail>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        //ArrayList<EarthquakeDetail> earthquakeDetail;

        //earthquakeDetail = QueryUtils.extractEarthquakes(SAMPLE_JSON_RESPONSE);

        //EarthquakeDetailAdapter earthquakeDetailAdapter = new EarthquakeDetailAdapter(this, earthquakeDetail);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                EarthquakeDetail obj = (EarthquakeDetail) o;
      ...
      //  task.execute(USGS_REQUEST_URL);
        ...
        if(!isConnected) {
            ...
            Log.e(LOG_TAG, "The init loader of the Loader Manager has been initialized. ");
            loaderManager.initLoader(1, null, this);
        }
    }

    @Override
    public Loader<ArrayList<EarthquakeDetail>> onCreateLoader(int i, Bundle bundle) {

        Log.e(LOG_TAG, "Calling the OnCreateLoader of the Loader class");
        ProgressBar progressBar = (ProgressBar) findViewById(R.id.loading_spinner);
        assert progressBar != null;
    ...
    @Override
    public void onLoadFinished(Loader<ArrayList<EarthquakeDetail>> loader, ArrayList<EarthquakeDetail> earthquakeDetails) {
        Log.e(LOG_TAG, "Calling the onLoadFinished of the Loader class");
    ...
    @Override
    public void onLoaderReset(Loader<ArrayList<EarthquakeDetail>> loader) {
        Log.e(LOG_TAG, "Calling the onLoaderReset of the Loader class");
        updateUI(new ArrayList<EarthquakeDetail>());
    }
/*
    @SuppressLint("StaticFieldLeak")
    private class EarthquakeAsyncTask extends AsyncTask<String, Void, ArrayList<EarthquakeDetail>> {

        @Override
        protected void onPreExecute() {
            Toast.makeText(EarthquakeActivity.this, "Data is loading from the server. ", Toast.LENGTH_SHORT).show();

        }

        @Override
        protected ArrayList<EarthquakeDetail> doInBackground(String... strings) {
        ...
        @Override
        protected void onPostExecute(ArrayList<EarthquakeDetail> earthquakeDetails) {

            if(earthquakeDetails.get(0) == null) {
                return;
            }
...
*/
    private void updateUI(ArrayList<EarthquakeDetail> earthquake) {
        ListView listView = (ListView) findViewById(R.id.list);
        if(earthquake != null) {
            EarthquakeDetailAdapter earthquakeDetailAdapter = new EarthquakeDetailAdapter(EarthquakeActivity.this, earthquake);
            assert listView != null;
            listView.setAdapter(earthquakeDetailAdapter);
        }
    }
